...
public class BasicArrayUtilTest {
    @Test
    public void fun1() throws InstantiationException, IllegalAccessException {
        ...
        BasicArrayUtil.setToEmptyGroup(strListArray, clazz);
    ...
    public void fun1_1() throws InstantiationException, IllegalAccessException {
        ...
        BasicArrayUtil.setToEmptyGroup(strMapArray, clazz);
    ...
    public void fun2() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        initList.add("aaa");
        initList.add("bbb");
        BasicArrayUtil.setGroupArrayTo(strListArray, initList, clazz);
        MyPrint.showArray(strListArray);
    }
    ...
    public void fun2_2() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        ...
        initMap.put("aaa", 10);
        initMap.put("bbb", 20);
        BasicArrayUtil.setGroupArrayTo(strMapArray, initMap, clazz);
        MyPrint.showArray(strMapArray);
    }
...
//        System.out.println(c);
    ...
    public void fun9 () {
        ...
        double x = 4.0;
        double y = BasicArrayUtil.getLinearTransformValue(x1, x2, x, y1, y2);
        System.out.println(y);
    }

    @Test
    public void fun10() {
        double[] result = BasicArrayUtil.getIncreasedoubleNumberArray(3.0, 0.3, 5.1, 2);
...
//        BasicArray.setDoubleArrayTo(arrB, 0);
        ...
        BasicArrayUtil.fillLinearTransformValue(leftValue, rightValue, arrA, 1, 4, true);
        BasicArrayUtil.fillLinearTransformValue(leftValue, rightValue, arrB, 1, 4, false);
